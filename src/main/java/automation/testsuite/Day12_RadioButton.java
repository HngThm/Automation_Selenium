...
public class Day12_RadioButton extends CommonBase{
	...
	public void openChrome() {
		driver = initChromeDriver(CT_PageURLs.URL_SELENIUMEASE2);
	}
	
	@Test
	public void case1_CheckDefaultValue() {
		WebElement radioMale1 = driver.findElement(By.xpath("//input[@name='optradio' and @value='Male']"));
		assertFalse(radioMale1.isSelected());
		
		WebElement radioFemale1 = driver.findElement(By.xpath("//input[@name='optradio' and @value='Female']"));
		assertFalse(radioFemale1.isSelected());
	}
